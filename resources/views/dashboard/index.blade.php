                    ...
                    <div class="card-body p-0 d-flex flex-fill">
                        <div class="row g-0 w-100">
                            ...
                            <div class="col-6 align-self-end text-end">
                                <img src="{{ asset('dash') }}/img/illustrations/customer-support.png" alt="Customer Support"
        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-4 d-flex">
                <div class="card flex-fill w-100">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-start">
                            <img src="{{ asset('dash') }}/img/avatars/avatar-5.jpg" width="36" height="36"
                        ...
                        <hr />
                        <div class="d-flex align-items-start">
                            <img src="{{ asset('dash') }}/img/avatars/avatar.jpg" width="36" height="36"
                        ...
                        <hr />
                        <div class="d-flex align-items-start">
                            <img src="{{ asset('dash') }}/img/avatars/avatar-4.jpg" width="36" height="36"
                            ...
                            <div class="d-flex">
                                <div class="flex-shrink-0">
                                    <div class="bg-body-tertiary rounded-2">
                                        <img class="p-2" src="{{ asset('dash') }}/img/brands/brand-1.svg">
                                    </div>
                                </div>
                    ...
                    <tr>
                        <td>
                            <div class="d-flex">
                                <div class="flex-shrink-0">
                                    <div class="bg-body-tertiary rounded-2">
                                        <img class="p-2" src="{{ asset('dash') }}/img/brands/brand-2.svg">
                                    </div>
                                </div>
                                <div class="flex-grow-1 ms-3">
                    ...
                    <tr>
                        <td>
                            <div class="d-flex">
                                <div class="flex-shrink-0">
                                    <div class="bg-body-tertiary rounded-2">
                                        <img class="p-2" src="{{ asset('dash') }}/img/brands/brand-3.svg">
                                    </div>
                                </div>
                                <div class="flex-grow-1 ms-3">
                    ...
                    <tr>
                        <td>
                            <div class="d-flex">
                                <div class="flex-shrink-0">
                                    <div class="bg-body-tertiary rounded-2">
                                        <img class="p-2" src="{{ asset('dash') }}/img/brands/brand-4.svg">
                                    </div>
                                </div>
                                <div class="flex-grow-1 ms-3">
                    ...
                    <tr>
                        <td>
                            <div class="d-flex">
                                <div class="flex-shrink-0">
                                    <div class="bg-body-tertiary rounded-2">
                                        <img class="p-2" src="{{ asset('dash') }}/img/brands/brand-5.svg">
                                    </div>
                                </div>
                                <div class="flex-grow-1 ms-3">
