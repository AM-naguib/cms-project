...
<body class=" custom-header-relative ">
    ...
    <div class="loader simple-loader">
        <div class="loader-body">
            <img src="{{ asset('front/new') }}/images/loader.gif" alt="loader" class="img-fluid " width="300">
        </div>
    </div>
                        ...
                        <div class="row row-cols-2 gx-2">
                            ...
                            <div class="col mb-3">
                                <div data-setting="attribute" class="text-center w-100">
                                    ...
                                    <label class="btn dir-btn cutomizer-button w-100"
                            ...
                            <div class="col">
                                <div data-setting="attribute" class="text-center w-100">
                                    <input type="radio" value="hulu" class="btn-check"
                                        name="theme_style_appearance" data-prop="data-bs-theme"
...
<!-- Mirrored from templates.iqonic.design/streamit-dist/frontend/html/movie.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 27 Aug 2024 19:23:44 GMT -->
